...
function getGridBuffers(gl, size) {
    ...
    const normalBuffer = Array(positionBuffer.length / 3)
        .fill([0, 0, 1])
        .flat()
...
export function drawGrid(gl, glProgram, parentMatrix, viewMatrix, projMatrix) {
    ...
    gl.drawElements(
        gl.LINE_STRIP,
        buffers.glIndexBuffer.number_vertex_point,
        gl.UNSIGNED_SHORT,
        0
    )
}
