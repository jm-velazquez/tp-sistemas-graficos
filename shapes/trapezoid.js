export class Trapezoid {
  ...
  getArrays() {
    ...
    const leftSideNormal = glMatrix.vec4.fromValues(
      -rightSideNormal[0],
      rightSideNormal[1],
      0,
      1,
    ...
    positionArray.push(
      glMatrix.vec4.fromValues(-this.base / 2, -this.height / 2, 0, 1),
    );
    ...
    positionArray.push(
      glMatrix.vec4.fromValues(this.top / 2, this.height / 2, 0, 1),
    );
    normalArray.push(rightSideNormal);
