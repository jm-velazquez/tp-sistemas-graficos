...
export function getSkybox(gl, textureMap) {
	...
	const glBuffers = getGlBuffersFromBuffers(gl, positionBuffer, normalBuffer, uvBuffer, indexBuffer);
	const aux = new Model();
	...
	skybox.translationVector = [- SIDE_LENGTH / 2, - SIDE_LENGTH / 2, - SIDE_LENGTH / 2];
