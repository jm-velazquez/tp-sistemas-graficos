import { translateMatricesAlongNormalAxis,
		getPositionsFromLevelMatrices } from "../curves/level-matrix-generator.js";
...
export class CarAnimation {
	...
	constructor(glMatrix, levelMatrices, velocity, normalOffset = 0) {
		this.levelMatrices = translateMatricesAlongNormalAxis(glMatrix, levelMatrices, normalOffset);
		const pathVertices = getPositionsFromLevelMatrices(this.levelMatrices).map(vertice => [vertice[0], vertice[2]]);
